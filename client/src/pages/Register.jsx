    ...
    <div className="flex-1 flex justify-center items-start lg:items-center p-6 lg:p-10">
      <div className="w-[90%] max-w-[400px] bg-white text-center mt-10 mb-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div
            type="submit"
            className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-3 text-center mb-4 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Sign Up
          </div>
        </form>
